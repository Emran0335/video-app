...
const VideoPanel = ({ videos }: VideoPanelProps) => {
  ...
  return (
    <>
      <div className="relative w-full mb-2 rounded-full bg-zinc-300 border py-1 pl-8 pr-3 overflow-hidden">
        <span className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-800">
          <Search />
        </span>
        <input
